...
class Figure():
    ...
    def create_figure(self, df):
        ...
        ax.plot(df['engine_rot_speed'], df['torque_on_wheel'], c='blue', lw=2.5, label="torque_on_wheel")
        ax.plot(df['engine_rot_speed'], df['power_in_KM'], c='red', lw=2.5, label="power[KM]")
